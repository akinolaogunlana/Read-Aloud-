...
function readPastedText(){
  ...
  loadDocument('Pasted Text', sections);
}
...
function pause(){ stopKeepAlive(); try{ speechSynthesis.pause(); }catch(e){} setPlayingUI(false); }
function stopSpeaking(){ stopKeepAlive(); try{ speechSynthesis.cancel(); }catch(e){} setPlayingUI(false); }
